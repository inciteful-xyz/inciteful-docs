...
|      resource_allocation |    REAL | Similar to Adamic/Adar, the [Resource Allocation](https://neo4j.com/docs/graph-data-science/current/alpha-algorithms/resource-allocation/) score of the paper is a link prediction algorithm which, when used in this context, can help to detect similarity between papers. |
